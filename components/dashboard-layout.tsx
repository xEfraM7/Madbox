...
const navigation = [
  ...
  { name: "Clases Especiales", href: "/dashboard/clases", icon: Calendar },
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-80">
                ...
                <div className="space-y-2 p-2">
                  <div className="text-sm p-2 rounded-md hover:bg-accent">
                    <p className="font-medium">Nuevo usuario registrado</p>
                    <p className="text-xs text-muted-foreground">Hace 5 minutos</p>
                  </div>
                  <div className="text-sm p-2 rounded-md hover:bg-accent">
                    <p className="font-medium">Pago vencido - Juan Pérez</p>
                    <p className="text-xs text-muted-foreground">Hace 2 horas</p>
                  </div>
                  <div className="text-sm p-2 rounded-md hover:bg-accent">
                    <p className="font-medium">Nueva clase programada</p>
