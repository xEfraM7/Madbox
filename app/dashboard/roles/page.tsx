...
const adminsData = [
  ...
  },
  {
    ...
    email: "laura@gimnasio.com",
    role: "Recepcionista",
    status: "active",
  },
  {
    id: 3,
    name: "Miguel Finanzas",
    email: "miguel@gimnasio.com",
    role: "Contador",
    status: "active",
  },
]
...
const rolesData = [
  {
    ...
    permissions: ["users", "payments", "plans", "roles", "settings", "reports"],
    userCount: 1,
  },
  {
    id: 2,
    name: "Recepcionista",
    description: "Gestión de usuarios y pagos básicos",
  ...
  },
  {
    ...
    permissions: ["payments", "plans", "reports"],
    userCount: 1,
  },
  {
    id: 4,
    name: "Instructor",
    description: "Gestión de clases y usuarios",
    permissions: ["users", "classes"],
    userCount: 5,
  },
]
                    ...
                    <TableBody>
                      {admins.map((admin) => (
                        <TableRow key={admin.id}>
                          ...
                          <TableCell>
                            <Badge>{admin.status === "active" ? "Activo" : "Inactivo"}</Badge>
                          </TableCell>
          ...
          <TabsContent value="permissions" className="space-y-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Lista completa de permisos que pueden asignarse a los roles
              </p>
            </div>
