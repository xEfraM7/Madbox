...
const plansData = [
  {
    ...
    price: 29.99,
    duration: "Mensual",
    features: ["Acceso al gimnasio", "Vestuarios", "Duchas"],
    active: true,
  },
  {
    id: 2,
    ...
    price: 49.99,
    duration: "Mensual",
    features: ["Todo lo del básico", "Clases grupales", "Asesoría nutricional"],
    active: true,
  },
  {
    id: 3,
    ...
    price: 299.99,
    duration: "Anual",
    features: ["Plan Premium", "2 meses gratis", "Entrenador personal 1x/mes"],
    active: true,
  },
  {
    id: 4,
    ...
    price: 19.99,
    duration: "Mensual",
    features: ["Acceso básico", "Horario limitado", "Requiere credencial"],
    active: false,
  },
]
