                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      <Label htmlFor="emailPayments">Notificaciones de pagos por email</Label>
                      <p className="text-sm text-muted-foreground">Recibe un correo cuando se registra un pago</p>
                    </div>
                    <Switch
                      id="emailPayments"
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      <Label htmlFor="emailNewUsers">Alertas de nuevos usuarios</Label>
                      <p className="text-sm text-muted-foreground">Notificación cuando se registra un nuevo miembro</p>
                    </div>
                    <Switch
                      id="emailNewUsers"
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      <Label htmlFor="smsReminders">Recordatorios por SMS</Label>
                      <p className="text-sm text-muted-foreground">Enviar recordatorios de pagos por SMS</p>
                    </div>
                    <Switch
                      id="smsReminders"
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      <Label htmlFor="paymentAlerts">Alertas de pagos vencidos</Label>
                      <p className="text-sm text-muted-foreground">Notificación cuando un pago está próximo a vencer</p>
                    </div>
                    <Switch
                      id="paymentAlerts"
              ...
              <CardHeader>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <CardDescription>Métodos de pago e impuestos</CardDescription>
                  </div>
                </div>
              </CardHeader>
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    {["Efectivo", "Tarjeta", "Transferencia", "PayPal"].map((method) => (
