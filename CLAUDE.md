...
- Permisos disponibles: `dashboard.view`, `users.{view,edit,delete}`, `plans.{view,edit,delete}`, `payments.{view,edit,delete}`, `classes.{view,edit,delete}`, `roles.{view,create,edit,delete}`, `settings.{view,edit}`, `closings.{view,edit,delete}`, `routines.{view,edit,delete}`, `products.{view,create,edit,delete}`.
